...
function add_qwiz_js () {
   ...
   wp_enqueue_script ('qwiz_handle',      $qwiz,      array (), '1.1b5', true);
   wp_enqueue_script ('qwizcard_handle',  $qwizcards, array (), '1.1b5', true);
   wp_enqueue_script ('jquery_ui_handle', $jquery_ui, array (), '1.1b5', true);
}
