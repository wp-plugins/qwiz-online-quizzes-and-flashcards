...
function add_qwiz_js () {
   ...
   wp_enqueue_script ('qwiz_handle',                 $qwiz,                 array (), '2.16', true);
   wp_enqueue_script ('qwizcard_handle',             $qwizcards,            array (), '2.16', true);
   wp_enqueue_script ('jquery_ui_handle',            $jquery_ui,            array (), '2.16', true);
   wp_enqueue_script ('jquery_ui_touchpunch_handle', $jquery_ui_touchpunch, array (), '2.16', true);
